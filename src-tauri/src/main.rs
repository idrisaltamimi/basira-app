...
fn main() {
    tauri::Builder::default()
        .invoke_handler(tauri::generate_handler![
            ...
            visit::get_filtered_visits_query::get_filtered_visits,
            ...
            visit::get_visits_count_query::get_visits_count,
            // Payment Queries
            ...
            payment::get_rebound_payments_query::get_rebound_payments,
            // Statics Queries
